...
/* index 0x1281 :   Client SDO 2 Parameter. */
                    ...
                    UNS32 TestMaster_obj1281_COB_ID_Client_to_Server_Transmit_SDO = 0x603;	/* 1538 */
                    UNS32 TestMaster_obj1281_COB_ID_Server_to_Client_Receive_SDO = 0x583;	/* 1410 */
                    UNS8 TestMaster_obj1281_Node_ID_of_the_SDO_Server = 0x3;	/* 2 */
...
/* index 0x1402 :   Receive PDO 3 Parameter. */
                    ...
                    UNS32 TestMaster_obj1402_COB_ID_used_by_PDO = 0x381;	/* 1025 */
...
/* index 0x1403 :   Receive PDO 4 Parameter. */
                    ...
                    UNS32 TestMaster_obj1403_COB_ID_used_by_PDO = 0x481;	/* 1281 */
...
const indextable * TestMaster_scanIndexOD (UNS16 wIndex, UNS32 * errorCode, ODCallback_t **callbacks)
{
	...
	*callbacks = NULL;
	switch(wIndex){
		...
		case 0x1F22: i = 19;break;
		case 0x2000: i = 20;*callbacks = MasterMap1_callbacks; break;
